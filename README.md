...
# 默认产物：dist/pilotserver-1.0.21-1-x64.spk
```

`1.0.21-1` 提供统一的概览 / 设备 / 行程 / 设置控制台，可在简体中文与英文间切换并记住语言选择，并支持在设置中导入已添加到 GitHub 的 SSH 私钥。此次升级不涉及 API 或数据库迁移；原有数据和设备端配置可继续使用。
