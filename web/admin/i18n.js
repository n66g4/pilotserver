(function () {
  ...
  const dictionaries = {
    ...
    en: {
      ...
      "settings.sshKeyHelp": "Add this public key to the comma user's authorized keys and enable SSH. The private key stays on the NAS.",
      "settings.sshPublicKey": "Public key",
      "settings.copySSHKey": "Copy public key",
      "settings.rotateSSHKey": "Regenerate",
      "settings.rotateSSHKeyConfirm": "Regenerating replaces the key immediately; update the car's authorized keys. Continue?",
      "settings.sshKeyCopied": "Public key copied",
      ...
      "ssh.authFailed": "Authentication failed. Confirm the NAS public key is on the device and SSH is enabled.",
