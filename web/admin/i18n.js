(function () {
  ...
  const dictionaries = {
    "zh-CN": {
      ...
      "settings.uploadTitle": "上传磁盘",
      "settings.uploadHelp": "0 表示不限制。每次上传后先删超过保留天数的文件，再按从旧到新删到容量上限以内；刚上传的文件会保留。",
      "settings.uploadMaxGB": "容量上限（GB）",
      "settings.uploadRetentionDays": "保留天数",
      "settings.uploadUsed": "已用 {used} GB",
      "settings.sshAuditTitle": "SSH 审计",
      "settings.sshAuditTime": "时间",
      "settings.sshAuditAction": "动作",
      "settings.sshAuditPort": "端口",
      "settings.sshAuditEmpty": "暂无记录",
      "settings.sshAuditTunnel": "开隧道",
      "settings.sshAuditPty": "网页终端",
      "settings.sshKeyTitle": "SSH 钥匙",
      "settings.sshKeyHelp": "钥匙按设备保存。把该车已信任的 OpenSSH 私钥粘贴到这里；私钥只留在 NAS，页面不会回显。",
      "settings.sshPrivateKey": "私钥",
      "settings.saveSSHKey": "保存钥匙",
      "settings.clearSSHKey": "清除钥匙",
      "settings.clearSSHKeyConfirm": "清除后需要重新为该设备粘贴私钥才能开终端。继续？",
      ...
      "settings.sshKeyCorrupt": "私钥文件损坏，请清除后重新粘贴",
      ...
      "ssh.keyUnconfigured": "请先为该设备保存 SSH 私钥",
    ...
    en: {
      ...
      "devices.openTerminal": "Open terminal",
      "devices.dongleId": "dongle_id",
      ...
      "settings.uploadTitle": "Upload disk",
      "settings.uploadHelp": "0 means no limit. After each upload, files older than the retention days are deleted first, then oldest files until usage is under the cap. The file just uploaded is kept.",
      "settings.uploadMaxGB": "Max size (GB)",
      "settings.uploadRetentionDays": "Retention (days)",
      "settings.uploadUsed": "Using {used} GB",
      "settings.sshAuditTitle": "SSH audit",
      "settings.sshAuditTime": "Time",
      "settings.sshAuditAction": "Action",
      "settings.sshAuditPort": "Port",
      "settings.sshAuditEmpty": "No records",
      "settings.sshAuditTunnel": "Tunnel",
      "settings.sshAuditPty": "Web terminal",
      "settings.sshKeyTitle": "SSH key",
      "settings.sshKeyHelp": "Keys are stored per device. Paste the OpenSSH private key this car trusts. The private key stays on the NAS and is never shown again.",
      "settings.sshPrivateKey": "Private key",
      "settings.saveSSHKey": "Save key",
      "settings.clearSSHKey": "Clear key",
      "settings.clearSSHKeyConfirm": "Clearing this device's key means you must paste it again before opening a terminal. Continue?",
      ...
      "settings.sshKeyCorrupt": "The stored key is unreadable. Clear it, then paste again.",

      "ssh.title": "SSH terminal",
      "ssh.copyCommand": "Copy command",
      "ssh.close": "Close",
      "ssh.connecting": "Connecting…",
      "ssh.offline": "Device is offline",
      "ssh.publicBaseUnconfigured": "Public base URL is not configured",
      "ssh.keyUnconfigured": "Save an SSH private key for this device first",
      ...
      "ssh.tunnelFailed": "Could not open the SSH tunnel",
