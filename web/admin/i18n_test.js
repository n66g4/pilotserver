...
test("dictionaries cover the complete localized admin workflow", () => {
  const required = [
    ...
    "settings.uploadTitle", "settings.uploadHelp", "settings.uploadMaxGB",
    "settings.uploadRetentionDays", "settings.uploadUsed",
    "settings.sshAuditTitle", "settings.sshAuditTime", "settings.sshAuditAction",
    "settings.sshAuditPort", "settings.sshAuditEmpty",
    "settings.sshAuditTunnel", "settings.sshAuditPty",
    ...
    "settings.sshKeyCleared", "settings.sshKeyInvalid", "settings.sshKeyCorrupt",
    ...
    "ssh.keyUnconfigured", "ssh.authFailed", "ssh.tunnelFailed",
